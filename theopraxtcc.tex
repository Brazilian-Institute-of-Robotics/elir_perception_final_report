...
% ********************************************************************
 \thesistitle{Percepção e suas funcionalidades para robô de inspeção em linhas de alta tensão}
    \hidevolume
    \thesisvolume{Volume 1 of 1}
    \thesisauthorr{Felipe Cafezeiro Plech}
    \thesisauthor{Luciana Moreno Borges}
